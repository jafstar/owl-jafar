...
import { CHART_REF_OBJECT } from "../../utils/refs";

import "./styles.css";

const Home = () => {
  // Refs
  const chartRef = React.useRef(CHART_REF_OBJECT);
                ...
                <div id="global-quote" className="">
                  <div id="global-quote-price" className="flex">
                    ...
                    <div>
                      ...
                      {showChangePerc ? (
                        <span
                          id="quote-change-perc"
                          onClick={() => setShowChangePerc(false)}
                        >
                          {parseFloat(
                        ...
                        <span
                          id="quote-change-price"
                          onClick={() => setShowChangePerc(true)}
                        >
